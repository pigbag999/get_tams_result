    ...
    for key in download_merge_dict.keys():
        ...
        for key2 in download_merge_dict[key].keys():
            if count_num >= max_download_num:
                ...
                file_name = key2
                download_local_path = os.path.join(now_path, 'log_path', f'{task_id}', device_id, type, package_name)
    ...
    if '-m' in task_id:
        ...
        for id in new_task_id:
            try:
                ...
                print('task {} have no result!'.format(id))
        ...
        try:
            ...
            print('task {} have no result!'.format(task_id))
